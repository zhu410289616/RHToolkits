...
+ (UIColor *)colorWithHexString:(NSString *)hexString
{
    ...
    return [UIColor colorWithHex:rgbValue];
}
...
+ (UIColor *)colorWithRGBAArray:(NSArray *)rgbaArray
{
    ...
    float redValue = [rgbaArray[0] floatValue];
    float greenValue = [rgbaArray[1] floatValue];
    float blueValue = [rgbaArray[2] floatValue];
    float alphaValue = [rgbaArray[3] floatValue];
 ...
 *  @return UIColor
 */
+ (UIColor *)colorWithRGBADictionary:(NSDictionary *)rgbaDict
{
    if (rgbaDict[@"r"] && rgbaDict[@"g"] && rgbaDict[@"b"] && rgbaDict[@"a"]) {
        return [UIColor clearColor];
    }
    float redValue = [rgbaDict[@"r"] floatValue];
    float greenValue = [rgbaDict[@"g"] floatValue];
    float blueValue = [rgbaDict[@"b"] floatValue];
    float alphaValue = [rgbaDict[@"a"] floatValue];
    return [UIColor colorWithRed:redValue green:greenValue blue:blueValue alpha:alphaValue];
}
 ...
 *  @return UIColor
 */
+ (UIColor *)colorWithHSBAArray:(NSArray *)hsbaArray
{
    if ([hsbaArray count] < 4) {
        return [UIColor clearColor];
    }
    float hueValue = [hsbaArray[0] floatValue];
    float saturationValue = [hsbaArray[1] floatValue];
    float brightnessValue = [hsbaArray[2] floatValue];
    float alphaValue = [hsbaArray[3] floatValue];
 ...
 *  @return UIColor
 */
+ (UIColor *)colorWithHSBADictionary:(NSDictionary *)hsbaDict
{
    if (hsbaDict[@"h"] && hsbaDict[@"s"] && hsbaDict[@"b"] && hsbaDict[@"a"]) {
        return [UIColor clearColor];
    }
    float hueValue = [hsbaDict[@"h"] floatValue];
    float saturationValue = [hsbaDict[@"s"] floatValue];
    float brightnessValue = [hsbaDict[@"b"] floatValue];
    float alphaValue = [hsbaDict[@"a"] floatValue];
    return [UIColor colorWithHue:hueValue saturation:saturationValue brightness:brightnessValue alpha:alphaValue];
}
